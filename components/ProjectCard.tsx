...
export default function ProjectCard({
  ...
  return (
    <Stack direction="column" spacing={1}>
      ...
      <Stack direction="row" gap={1} alignItems="center" flexWrap="wrap" justifyContent="flex-start">
        <Typography variant="body1" color="text.secondary" fontFamily={fontSecondary.style.fontFamily}>
          Technologies:{" "}
        </Typography>
        {technologies?.map((t, index) => (
          <Fragment key={t}>
            ...
            {index !== technologies.length - 1 && (
              <Divider orientation="vertical" flexItem sx={{ height: 16, margin: 0.5 }} />
            )}
          </Fragment>
        ))}
      </Stack>
        ...
        <Stack direction="row" spacing={1} alignItems="center" justifyContent="flex-start">
          <Stack
            ...
            sx={{
              ...
              color: "GrayText",
              svg: { color: "red" },
              "&:hover": { color: "GrayText !important", textDecorationColor: "red !important" },
            }}
          >
            <svg
